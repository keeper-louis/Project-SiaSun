...
namespace Keeper.Siasun.Mes.Project.WebMesTest {
    using System;
    ...
    public partial class MaterialMessageFromCappServiceService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback ReceiveYctBackOutsourcingInfoOperationCompleted;
        
        private System.Threading.SendOrPostCallback MaterialProcessMessageFromCappOperationCompleted;
        
        private System.Threading.SendOrPostCallback WeightingAvgNumerOperationCompleted;
        ...
        public MaterialMessageFromCappServiceService() {
            this.Url = global::Keeper.Siasun.Mes.Project.Properties.Settings.Default.Keeper_Siasun_Mes_Project_WebMesTest_MaterialMessageFromCappServiceService;
        ...
        /// <remarks/>
        public event ReceiveYctBackOutsourcingInfoCompletedEventHandler ReceiveYctBackOutsourcingInfoCompleted;
        
        /// <remarks/>
        public event MaterialProcessMessageFromCappCompletedEventHandler MaterialProcessMessageFromCappCompleted;
        
        /// <remarks/>
        public event WeightingAvgNumerCompletedEventHandler WeightingAvgNumerCompleted;
        ...
        public string ReceiveYctBackOutsourcingInfo([System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)] string OutSourcingInfo) {
            object[] results = this.Invoke("ReceiveYctBackOutsourcingInfo", new object[] {
                        OutSourcingInfo});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void ReceiveYctBackOutsourcingInfoAsync(string OutSourcingInfo) {
            this.ReceiveYctBackOutsourcingInfoAsync(OutSourcingInfo, null);
        }
        
        /// <remarks/>
        public void ReceiveYctBackOutsourcingInfoAsync(string OutSourcingInfo, object userState) {
            if ((this.ReceiveYctBackOutsourcingInfoOperationCompleted == null)) {
                this.ReceiveYctBackOutsourcingInfoOperationCompleted = new System.Threading.SendOrPostCallback(this.OnReceiveYctBackOutsourcingInfoOperationCompleted);
            }
            this.InvokeAsync("ReceiveYctBackOutsourcingInfo", new object[] {
                        OutSourcingInfo}, this.ReceiveYctBackOutsourcingInfoOperationCompleted, userState);
        }
        
        private void OnReceiveYctBackOutsourcingInfoOperationCompleted(object arg) {
            if ((this.ReceiveYctBackOutsourcingInfoCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ReceiveYctBackOutsourcingInfoCompleted(this, new ReceiveYctBackOutsourcingInfoCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("", RequestNamespace="http://service.webservice.mes.lgcx.com/", ResponseNamespace="http://service.webservice.mes.lgcx.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute("return", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string WeightingAvgNumer([System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)] string matecodeAvg) {
            object[] results = this.Invoke("WeightingAvgNumer", new object[] {
                        matecodeAvg});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void WeightingAvgNumerAsync(string matecodeAvg) {
            this.WeightingAvgNumerAsync(matecodeAvg, null);
        }
        
        /// <remarks/>
        public void WeightingAvgNumerAsync(string matecodeAvg, object userState) {
            if ((this.WeightingAvgNumerOperationCompleted == null)) {
                this.WeightingAvgNumerOperationCompleted = new System.Threading.SendOrPostCallback(this.OnWeightingAvgNumerOperationCompleted);
            }
            this.InvokeAsync("WeightingAvgNumer", new object[] {
                        matecodeAvg}, this.WeightingAvgNumerOperationCompleted, userState);
        }
        
        private void OnWeightingAvgNumerOperationCompleted(object arg) {
            if ((this.WeightingAvgNumerCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.WeightingAvgNumerCompleted(this, new WeightingAvgNumerCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3056.0")]
    public delegate void ReceiveYctBackOutsourcingInfoCompletedEventHandler(object sender, ReceiveYctBackOutsourcingInfoCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3056.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class ReceiveYctBackOutsourcingInfoCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal ReceiveYctBackOutsourcingInfoCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3056.0")]
    public delegate void WeightingAvgNumerCompletedEventHandler(object sender, WeightingAvgNumerCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3056.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class WeightingAvgNumerCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal WeightingAvgNumerCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
